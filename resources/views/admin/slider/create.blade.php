...
<section class="content-header">
	...
	<div class="box">
		...
		<form action="{{ url('/slider') }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
		{{ csrf_field() }}
			<div class="box-body">
				<div class="col-lg-12">
					...
					<div class="form-group @if ($errors->has('judul')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<input type="text" class="form-control" placeholder="Nama Slider" name="judul" value="{{ old('judul') }}" >
						</div>
					</div>
					...
					<div class="form-group @if ($errors->has('isi')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<input type="text" class="form-control" placeholder="Nama Slider" name="isi" value="{{ old('isi') }}" >
						</div>
					</div>
