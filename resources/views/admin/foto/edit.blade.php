...
<section class="content-header">
	...
	<div class="box">
		...
		<form action="{{ url('/foto/edit/'.$foto->id) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
		{{ csrf_field() }}
			...
			<div class="box-body">
				...
				<div class="form-group @if ($errors->has('judul')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<input type="text" class="form-control" placeholder="Nama Foto" name="judul" value="{{ $foto->judul }}" >
						</div>
					</div>
					...
					<div class="form-group @if ($errors->has('isi')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<br><br>
							@if($foto->gambar)
								<img src="{{ url('/upload/foto/'.$foto->gambar) }}" width="150px" height="100px">
							@endif
						</div>
					</div>
