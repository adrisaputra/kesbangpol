        ...
        <div class="row mt-5 justify-content-center" data-aos="fade-up">
          <div class="col-lg-10">
              ...
              <div class="row">
                ...
                <div class="col-md-7 form-group">
                  <textarea class="form-control" disabled>{{ $skk_ormas->perbaikan }}</textarea>
                </div>
              </div>

            <form action="{{ url('/pengajuan_skk_ormas_w/perbaikan/'.$skk_ormas->id)}}" method="POST" enctype="multipart/form-data">
            {{ csrf_field() }}
