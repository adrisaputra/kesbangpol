      ...
      <div class="container" >
        ...
        <div class="row mt-5 justify-content-center" data-aos="fade-up">
          <div class="col-lg-10">
            ...
            <form action="{{ url('/pengajuan_skt_ormas_w/edit/'.$skt_ormas->id)}}" method="POST" enctype="multipart/form-data">
            {{ csrf_field() }}
            ...
            {{ csrf_field() }}
              ...
              <div class="row">
                ...
                @if($skt_ormas->biodata_sekretaris)
                  <div class="col-md-7 form-group">
            ...
            {{ csrf_field() }}
              ...
              <div class="row">
                ...
                @if($skt_ormas->biodata_bendahara)
                  <div class="col-md-7 form-group">
            ...
            {{ csrf_field() }}
              ...
              <div class="row">
                ...
                @if($skt_ormas->surat_pernyataan_permendagri)
                  <div class="col-md-7 form-group">
