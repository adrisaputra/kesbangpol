        ...
        <div class="row mt-5 justify-content-center" data-aos="fade-up">
          ...
          <div class="col-lg-10">
              ...
              <div class="row">
                ...
                <div class="col-md-7 form-group">
                  <textarea class="form-control" disabled>{{ $izin_penelitian->perbaikan }}</textarea>
                </div>
              </div>


            <form action="{{ url('/pengajuan_izin_penelitian_w/perbaikan/'.$izin_penelitian->id)}}" method="POST" enctype="multipart/form-data">
            {{ csrf_field() }}
            ...
            {{ csrf_field() }}
              ...
              @if($izin_penelitian->surat_perguruan_tinggi && $izin_penelitian->proposal_penelitian && $izin_penelitian->ktp_peneliti && $izin_penelitian->izin_penelitian)
                ...
                <button type="submit" class="btn btn-success" style="background: #d41e10;border: 0;padding: 10px 24px;color: #fff;transition: 0.4s;border-radius: 4px;" onclick="return confirm('Anda Yakin ?');">Kirim Ulang Permohonan</button>
              @endif
